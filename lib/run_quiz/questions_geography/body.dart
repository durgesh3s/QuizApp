...
import 'package:untitled/run_quiz/questions_geography/progress_bar.dart';
import 'package:untitled/run_quiz/questions_geography/question_card.dart';
...
class body extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    QuestionController_geo _questionController = Get.put(QuestionController_geo());
    return SafeArea(
      child: Padding(
